...
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'الشبح')
--     Source DevProx     --
...
if text and text:match('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "الشبح")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbs:get(DevProx..'Abs:NameBot') or "الشبح")..' ','')
end
...
local DevProxTEAM = '༒︎︙اهلا عزيزي ↫ '..AbsRank(msg)..' \n༒︎︙تم تفعيل التواصل بنجاح'
...
Dev_Abs(msg.chat_id_, msg.id_, 1, '༒︎︙عدد اعضاء المجموعه اقل من ↫ *'..(DevAbs:get(DevProx..'Abs:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
if DevAbs:get(DevProx.."Abs:Text:BotWelcome") then AbsText = DevAbs:get(DevProx.."Abs:Text:BotWelcome") else AbsText = "༒︎︙مرحبا انا بوت اسمي "..NameBot.."\n༒︎︙حالة المجموعه ↫ "..BotText.."\n┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉" end 
...
local BotName = (DevAbs:get(DevProx.."Abs:NameBot") or 'الشبح')
...
File:write(GetJson)
File:close()
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './'..DevProx..'.json', '༒︎︙يحتوي الملف على ↫ '..#List..' مجموعه',dl_cb, nil)
...
if text and text == (DevAbs:get(DevProx..'Abs:NameBot') or 'الشبح') then 
NameBot = (DevAbs:get(DevProx..'Abs:NameBot') or 'الشبح')
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'༒︎︙عدد النقاط التي ربحتها ↫ '..(DevAbs:get(DevProx..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbs:del(DevProx..'Abs:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbs:del(DevProx..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع نقاطك', 1, 'md') end
--     Source DevProx     --
...
name = string.gsub(name,'🎚','🎚')
name = string.gsub(name,'☎️','☎️')
DevProxTEAM = '༒︎︙اول واحد يدز هذا السمايل يربح ↫ '..name
...
DevProxTEAM = '༒︎︙مبروك لقد ربحت في اللعبه \n༒︎︙ارسل ↫ سمايلات للعب مره اخرى'
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
...
DevProxTEAM = '༒︎︙اول واحد يرتبها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(DevProx..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(DevProx..'Abs:Games:Ids'..msg.chat_id_) then
...
DevProxTEAM = '༒︎︙اول واحد يحلها يربح ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
if text == DevAbs:get(DevProx..'Abs:GameNum'..msg.chat_id_) and not DevAbs:get(DevProx..'Abs:Games:Ids'..msg.chat_id_) then
...
DevProxTEAM = '༒︎︙ما معنى هذا السمايل :؟ ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
...
DevProxTEAM = '༒︎︙ما هو عكس كلمة ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
...
name = string.gsub(name,'👩‍⚖️','👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👨‍⚖️👩‍⚖️👨‍⚖️👨‍⚖️')
name = string.gsub(name,'👨‍🎨','👩‍🎨👩‍🎨👨‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨👩‍🎨')
DevProxTEAM = '༒︎︙اول واحد يطلع المختلف يربح\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
...
DevProxTEAM = '༒︎︙اكمل المثال التالي ↫ ['..name..']'
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
...
DevProxTEAM = '༒︎︙اكمل المعادله التاليه ↫ ⤈\n{'..name..'} '
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
...
DevProxTEAM = '༒︎︙ما معنى كلمة ↫ '..name
Dev_Abs(msg.chat_id_, msg.id_, 1,DevProxTEAM, 1, 'md')
return false
end end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'༒︎︙تم بيع '..(DevAbs:get(DevProx..'Abs:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n༒︎︙كل نقطه تساوي 50 رساله', 'md')
...
┉ ≈ ┉ ≈ ┉ ≈ ┉ ≈ ┉
༒︎︙[Tws DevProx](https://t.me/FIIFFFFF)
]]
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevAbs:get(DevProx..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Abs(msg.chat_id_, msg.id_, 1, "༒︎︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAbs:get(DevProx..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Abs(msg.chat_id_, msg.id_, 1, "༒︎︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
...
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbs:del(DevProx..'Abs:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevAbs:del(DevProx..'Abs:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abs(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     Source DevProx     --
if text == "المطور" then 
local Check = https.request('https://api.telegram.org/bot'..TokenBot..'/getChat?chat_id='..DevAbs:get(DevProx.."Abs:ChId"))
local GetInfo = JSON.decode(Check)
...
sudobot = '\n༒︎︙عدد الكروبات ↫ '..(DevAbs:get(DevProx..'Abs:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n༒︎︙عدد الكروبات ↫ '..(DevAbs:get(DevProx..'Abs:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n༒︎︙عدد الكروبات ↫ '..(DevAbs:get(DevProx..'Abs:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Abs(msg.chat_id_, msg.id_, 1,'༒︎︙عدد الكروبات الان ↫ { '..#group..' }'..DevProxgp1..DevProxgp2..'\n༒︎︙العدد الحقيقي الان  ↫ ( '..DevProxgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
if M ~= 0 then
Dev_Abs(msg.chat_id_, msg.id_, 1, "༒︎︙عدد الميديا ↫ "..M.."\n༒︎︙الحذف التلقائي ↫ "..(DevAbs:get(DevProx..'Abs:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
...
{{text = '༒︎ DevProx TeAM .',url="t.me/DDDFDI"}},
}
...
sendDocument(msg.chat_id_, msg.id_, 0, 1, nil, './DevProx.lua', '༒︎︙نسخة ملف سورس الشبح',dl_cb, nil)
end end
--     Source DevProx     --
...
os.execute('wget https://raw.githubusercontent.com/DevProxTEAM/DevProx/main/DevProx.lua') 
dofile('DevProx.lua') 
