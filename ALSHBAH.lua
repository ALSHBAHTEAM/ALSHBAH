------------------------------------------------
-- This Source Was Developed By (Abd) @ICE50.--
...
NameBot = (DevAbd:get(ALSHBAH..'Abd:NameBot') or 'تفاحه')
--     Source ALSHBAH     --
...
if text and text:match('^'..(DevAbd:get(ALSHBAH..'Abd:NameBot') or "تفاحه")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevAbd:get(ALSHBAH..'Abd:NameBot') or "تفاحه")..' ','')
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'ICE53')..')'..' ❩\n↯︙تم رفعه ❨ '..DEV_Abd..' ❩ بنجاح', 1, 'md')
...
if mrAbd == "مميز" and VipMem(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '↯︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'ICE53')..')'..' ❩\n↯︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بتعديل وتغيير كلايش سورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ السورس ↯' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بتحديث  سورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'تحديث السورس','تحديث'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه ب أحصائيات  سورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'الاحصائيات'},
{'المشتركين','المجموعات'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه ب المطورين لسورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'المطورين','الثانويين'},
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه ب التفعيل والتعطيل لسورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بالاذاعه لسورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'اذاعه بالتثبيت'},
{'اذاعه خاص','اذاعه عام'},
...
if text == '↫ العام ↯' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بالعام لسورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بردود الخاص لسورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بالاشتراك الاجباري لسورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
...
if text == '↫ المتجر ↯' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '↯︙اهلا بك مجددا عزيزي المطور \n↯︙اليك الازرار الخاصه بمتجر سورس تفاحه فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'المتجر'},
...
local inline = {
{{text="↯ المطور .",url="t.me/"..(dp.username_ or "ICE53")}},
{{text="↯ السورس .",url="https://t.me/ICE53"},{text="↯ لتنصيب بوت .",url="https://t.me/ICE50"}},
}
...
Dev_Abd(msg.sender_user_id_, msg.id_, 1, '↯︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "ICE53")..')', 1, 'md') 
...
local Welcomes = Welcomes:gsub('username',('[@'..result.username_..']' or '[@تفاحه]'))
...
local BotName = (DevAbd:get(ALSHBAH.."Abd:NameBot") or 'تفاحه')
...
if text and text == (DevAbd:get(ALSHBAH..'Abd:NameBot') or 'تفاحه') then 
NameBot = (DevAbd:get(ALSHBAH..'Abd:NameBot') or 'تفاحه')
...
↯︙نقاطي • بيع نقاطي
┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉
↯︙[Source Channel](https://t.me/ICE53)
]], 1, 'md')
else
...
Text = [[
Welcome To Source
↯︙[ALSHBAH TeAm](https://t.me/ICE53)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↯ Source Channel',url="https://t.me/ICE53"}},
{{text = '↯ Developer',url="https://t.me/ICE50"}},
{{text = '↯ Tws ALSHBAH',url="https://t.me/TeAM_AnGeLebot"}},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..TokenBot..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/ICE53&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
return false
end
--     Source ALSHBAH     --
if ChatType == 'sp' or ChatType == 'gp'  then
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '↯ ALSHBAH TeAm .',url="t.me/ICE53"}},
}
local msg_id = msg.id_/2097152/0.5
...
ConstructorAbd = "["..Abd.first_name_.."](T.me/"..(Abd.username_ or "ICE53")..")"
else 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '↯︙جاري تحديث سورس تفاحه', 1, 'md') 
...
DevAbd:set(ALSHBAH..'Abd:NameBot',(DevAbd:get(ALSHBAH..'Name:Bot') or 'تفاحه'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '↯︙Channel ↬ @ICE53', 1, 'html')    
end 
--     Source ALSHBAH     --
if Sudo(msg) then 
