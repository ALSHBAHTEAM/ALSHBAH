...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙عذرا عزيزي ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "Reply" then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙العضو ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
if status == "ReplyBy" then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙بواسطة ↫ ["..dp.first_name_.."](T.me/"..UserName..")".."\n"..text, 1, 'md')
return false
end
else
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙الحساب محذوف قم بالتاكد واعد المحاوله", 1, 'md')
end
end,nil)   
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف الامر من المجموعه", 1, 'html')  
else
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لايوجد امر بهذا الاسم", 1, 'html')
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل الامر الجديد", 1, 'html')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حفظ الامر", 1, 'html')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف الاوامر المضافه في المجموعه", 1, 'html')
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل الامر القديم", 1, 'html')
return false
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل الامر الذي قمت باضافته يدويا", 1, 'html')
return false
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
if #List == 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لاتوجد صلاحيات مضافه", 1, 'html')
return false
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف الصلاحيات المضافه", 1, 'html')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل نوع الصلاحيه \n{ عضو • مميز  • ادمن  • مدير }\n༒︎︙ارسل الغاء لالغاء الامر ", 1, 'html')
end
if text and text:match("^حذف صلاحيه (.*)$") and ChCheck(msg) or text and text:match("^مسح صلاحيه (.*)$") and ChCheck(msg) then 
ComdNew = text:match("^حذف صلاحيه (.*)$") or text:match("^مسح صلاحيه (.*)$")
DevAbd:del(ALSHBAH.."Comd:New:rt:Abd:"..ComdNew..msg.chat_id_)
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف الصلاحيه", 1, 'html')
end
if DevAbd:get(ALSHBAH.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) then 
if text and text:match("^الغاء$") then 
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم الغاء الامر", 1, 'html')
DevAbd:del(ALSHBAH.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
if text == "مدير" then
if not Constructor(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تستطيع اضافة صلاحية ( عضو • مميز  • ادمن )\n༒︎︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "ادمن" then
if not Manager(msg) then 
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تستطيع اضافة صلاحية ( عضو • مميز )\n༒︎︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
if text == "مميز" then
if not Admin(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تستطيع اضافة صلاحية ( عضو )\n༒︎︙ارسال نوع الصلاحيه مره اخرى", 1, 'html')
return false
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم اضافة الصلاحيه", 1, 'html')
DevAbd:del(ALSHBAH.."Comd:New"..msg.chat_id_..""..msg.sender_user_id_) 
return false  
end 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'DDDFDI')..')'..' ❩\n༒︎︙تم رفعه ❨ '..DEV_Abd..' ❩ بنجاح', 1, 'md')
...
local mrAbd = DevAbd:get(ALSHBAH.."Comd:New:rt:Abd:"..DEV_Abd..msg.chat_id_)
if mrAbd == "مميز" and VipMem(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙العضو ↫ ❨ ['..data.first_name_..'](t.me/'..(data.username_ or 'DDDFDI')..')'..' ❩\n༒︎︙تم تنزيله ❨ '..DEV_Abd..' ❩ بنجاح', 1, 'md')
...
if mrAbd == "مميز" and VipMem(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙العضو ↫ ❨ ['..result.title_..'](t.me/'..(text1[3] or 'DDDFDI')..')'..' ❩\n༒︎︙تم رفعه ❨ '..text1[2]..' ❩ بنجاح', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙*المعرف غير صحيح*", 1, 'md')
end
end
...
Dev_Abd(msg.sender_user_id_, msg.id_, 1, '༒︎︙تم ارسال رسالتك الى [المطور](t.me/'..(chat.username_ or "DDDFDI")..')', 1, 'md') 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙العضو قام بحظر البوت لا تستطيع ارسال الرسائل له', 1, 'md')
return false  
end 
if text then
...
if text == 'الغاء' then   
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء حفظ كليشة الستارت', 1, 'md')
DevAbd:del(ALSHBAH..'Abd:Start:Bots'..msg.sender_user_id_) 
return false
end
DevAbd:set(ALSHBAH.."Abd:Start:Bot",text)  
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ كليشة الستارت', 1, 'md')
DevAbd:del(ALSHBAH..'Abd:Start:Bots'..msg.sender_user_id_) 
return false
end
if SecondSudo(msg) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙ارسل لي كليشة الستارت الان', 1, 'md')
return false
end
if text == 'حذف رد الخاص' or text == 'حذف كليشه ستارت' or text == '↫ حذف رد الخاص ༒︎' then 
DevAbd:del(ALSHBAH..'Start:Bot') 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف كليشة الستارت بنجاح', 1, 'md')
end
...
local ALSHBAHTeAm = '༒︎︙اهلا عزيزي ↫ '..AbdRank(msg)..' \n༒︎︙تم تفعيل التواصل بنجاح'
...
if ChatType == 'pv' then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لاتستطيع تفعيلي هنا يرجى اضافتي في مجموعه اولا', 1, 'md')
return false
end
if ChatType ~= 'sp' then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المجموعه عاديه وليست خارقه لا تستطيع تفعيلي يرجى ان تضع سجل رسائل المجموعه ضاهر وليس مخفي ومن بعدها يمكنك رفعي ادمن ثم تفعيلي', 1, 'md')
return false
end
if msg.can_be_deleted_ == false then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙البوت ليس ادمن يرجى ترقيتي !', 1, 'md')
return false  
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المجموعه بالتاكيد مفعله', 1, 'md')
else
if tonumber(data.member_count_) < tonumber(DevAbd:get(ALSHBAH..'Abd:Num:Add:Bot') or 0) and not SecondSudo(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عدد اعضاء المجموعه اقل من ↫ *'..(DevAbd:get(ALSHBAH..'Abd:Num:Add:Bot') or 0)..'* عضو', 1, 'md')
return false
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع تفعيل هذه المجموعه بسبب تعطيل البوت الخدمي من قبل المطور الاساسي', 1, 'md') 
end 
end 
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙الكلمه ↫ '..msg.content_.text_..' تم حذفها',  1, "html")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء حفظ الرد', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ الرد الجديد', 1, 'md') 
DevAbd:del(ALSHBAH..'Abd:Add:GpText'..msg.sender_user_id_..''..msg.chat_id_..'')
DevAbd:del(ALSHBAH..'DelManagerRep'..msg.chat_id_..'')
return false 
end 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عدد مشاهدات المنشور هي ↫ ('..msg.views_..')', 1, 'md')
DevAbd:del(ALSHBAH..'Abd:viewget'..msg.sender_user_id_)
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
local AbdText = (DevAbd:get(ALSHBAH.."Abd:Text:BotWelcome") or "༒︎︙مرحبا انا بوت اسمي "..NameBot.."\n༒︎︙حالة المجموعه ↫ "..BotText.."\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ الرابط بنجاح', 1, 'md')
DevAbd:del(ALSHBAH.."Abd:Set:Groups:Links"..msg.chat_id_..""..msg.sender_user_id_) 
return false 
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء الامر', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_,  1, "༒︎︙تم اضافة "..numadded..' رساله', 1, 'md')
DevAbd:del('ALSHBAHTeAm:'..ALSHBAH..'id:user'..msg.chat_id_) 
end
end
if text and Constructor(msg) then 
...
Dev_Abd(msg.chat_id_, msg.id_,  1, "༒︎︙تم اضافة "..numadded..' نقطه', 1, 'md')
DevAbd:del('ALSHBAHTeAm:'..ALSHBAH..'ids:user'..msg.chat_id_)  
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حفظ كليشة المطور", 1, "md")
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ اسم البوت ', 1, 'html')
DevAbd:del(ALSHBAH..'Abd:NameBot'..msg.sender_user_id_)
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙Group Link ↬ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"..DevAbd:get(ALSHBAH.."Abd:Groups:Links"..msg.chat_id_), 1, "html")
else 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لايوجد رابط ارسل ↫ ضع رابط او ارسل ↫ انشاء رابط للانشاء', 1, 'md')
end
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙جلب رابط المجموعه معطل', 1, 'md')
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙لم تربح اي نقطه\n༒︎︙ارسل ↫ الالعاب للعب', 1, 'md')
else 
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙عدد النقاط التي ربحتها ↫ '..(DevAbd:get(ALSHBAH..'Abd:GamesNumber'..msg.chat_id_..msg.sender_user_id_)), 1, 'md')
end
end
if text ==  'حذف رسائلي' and ChCheck(msg) or text ==  'مسح رسائلي' and ChCheck(msg) then DevAbd:del(ALSHBAH..'Abd:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع رسائلك', 1, 'md') end
if text ==  'حذف نقاطي' and ChCheck(msg) or text ==  'مسح نقاطي' and ChCheck(msg) then DevAbd:del(ALSHBAH..'Abd:GamesNumber'..msg.chat_id_..msg.sender_user_id_) Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع نقاطك', 1, 'md') end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1,"༒︎︙عذرا لا يمكنك تخمين عدد اكبر من الـ20 خمن رقم ما بين الـ1 والـ20", 1, 'md')
return false  end 
...
DevAbd:incrby(ALSHBAH..'Abd:GamesNumber'..msg.chat_id_..msg.sender_user_id_,5)  
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙*التخمين الصحيح هو* ↫ '..NUM..'\n༒︎︙*مبروك لقد ربحت وحصلت على 5 نقاط يمكنك استبدالها بالرسائل*', 1, 'md')
elseif tonumber(NUM) ~= tonumber(GETNUM) then
...
DevAbd:del(ALSHBAH..'Set:Num'..msg.chat_id_..msg.sender_user_id_)
DevAbd:del(ALSHBAH.."GAME:TKMEN" .. msg.chat_id_ .. "" .. msg.sender_user_id_)   
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙*التخمين الصحيح هو* ↫ '..GETNUM..'\n༒︎︙*للاسف لقد خسرت حاول مره اخرى لتخمين الرقم الصحيح*', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙لقد خمنت الرقم الخطا وتبقى لديك '..SetNum..' ارسل رقم تخمنه مره اخرى للفوز', 1, 'md')
end
end
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙حسنا لنلعب , ارسل عدد اللاعبين للروليت .', 1, 'md')
return false  
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙المعرف غير صحيح يرجى ارسال معرف صحيح', 1, 'md')
return false 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عذرا الالعاب معطله في المجموعه', 1, 'md')
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙تم بيع '..(DevAbd:get(ALSHBAH..'Abd:GamesNumber'..msg.chat_id_..msg.sender_user_id_))..' من نقاطك\n༒︎︙كل نقطه تساوي 50 رساله', 'md')
...
if num == 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لا يوجد ادمنيه ليتم رفعهم\n༒︎︙تم رفع مالك المجموعه", 1, 'md')
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم رفع '..num..' من الادمنيه \n༒︎︙تم رفع مالك المجموعه', 1, 'md')
end
end,nil) 
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_,msg.id_, 1, "༒︎︙المغادره معطله من قبل المطور الاساسي", 1, 'md')
return false  
end
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم مغادرة المجموعه \n༒︎︙تم حذف جميع بياناتها ', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙موقعك ↫ '..rtpa, 1, 'md')
end,nil)
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙للمطور الاساسي فقط ', 1, 'md')
else
...
DevAbd:del(ALSHBAH..'DevAbd2') DevAbd:del(ALSHBAH..'DevAbd3')
Dev_Abd(msg.chat_id_, msg.id_, 1,"༒︎︙تم حذف قناة الاشتراك الاجباري", 1, 'md') 
end
end
if SecondSudo(msg) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم اذاعة رسالتك بالتوجيه \n༒︎︙‏في ↫ ❨ '..#GpList..' ❩ مجموعه \n༒︎︙والى ↫ ❨ '..#PvList..' ❩ مشترك \n ✓', 1, 'md')
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙حسنا قم باعادة توجيه للمنشور الذي تريدني حساب مشاهداته', 1, 'md')
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عذرا هذه الخاصيه معطله ', 1, 'md')
return false
end
...
local user_msgs = DevAbd:get(ALSHBAH..'Abd:UsersMsgs'..msg.chat_id_..':'..msg.sender_user_id_)
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙عدد رسائلك هنا ↫ *❨ "..user_msgs.." ❩*", 1, 'md')
end
...
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
if text == "اهمس" or text == "همسه" or text == "اريد بوت الهمسه" or text == "دزلي بوت الهمسه" or  text == "دزولي بوت الهمسه" then  Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙@HMSEBOT', 1, 'md') end
...
if text == "جهاتي" and ChCheck(msg) or text == "اضافاتي" and ChCheck(msg) then add = (tonumber(DevAbd:get(ALSHBAH..'Abd:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_)) or 0) Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙عدد جهاتك المضافه ↫ *❨ "..add.." ❩* ", 1, 'md') end
if text == "تعديلاتي" or text == "سحكاتي" and ChCheck(msg) then local edit_msg = DevAbd:get(ALSHBAH..'Abd:EditMsg'..msg.chat_id_..msg.sender_user_id_) or 0  Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙عدد تعديلاتك ↫ *❨ "..edit_msg.." ❩* ", 1, 'md') end
if text == "ايديي" and ChCheck(msg) then Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙ايديك ↫ ❨ `'..msg.sender_user_id_..'` ❩', 1, 'md') end
if text == "رتبتي" and ChCheck(msg) then Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙رتبتك ↫ '..IdRank(msg.sender_user_id_, msg.chat_id_), 1, 'html') end
if text == "ايدي المجموعه" and ChCheck(msg) then Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ايدي المجموعه ↫ `"..msg.chat_id_.."`", 1, 'md') end
if text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' or text == 'حذف سحكاتي' or text == 'حذف تعديلاتي' then DevAbd:del(ALSHBAH..'Abd:EditMsg'..msg.chat_id_..msg.sender_user_id_) Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع تعديلاتك بنجاح' , 1, 'md') end
if text == 'مسح جهاتي' or text == 'مسح اضافاتي' or text == 'حذف جهاتي' or text == 'حذف اضافاتي' then DevAbd:del(ALSHBAH..'Abd:ContactNumber'..msg.chat_id_..':'..msg.sender_user_id_) Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف جميع جهاتك المضافه' , 1, 'md') end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
if text == "المطور" then 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙*Dev User* ↬ ['..DevUser..']\n༒︎︙*Dev Id* ↬ '..DevId..''..DevCh, 1, "md")
end
end,nil)
end 
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙العضو غير موجود في المجموعه', 1, 'md') 
end 
end 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لاتستطيع تنزيل المطور الاساسي", 1, 'md')
return false 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا يمكن تنزيل المالك الاساسي', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙هذا الامر للمالكين والمطورين فقط', 1, 'md')
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
--    Set  Constructor    --
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙لاتستطيع رفع احد وذالك بسبب تعطيل الرفع من قبل المنشئيين', 1, 'md')
return false
end
DevAbd:sadd(ALSHBAH..'Abd:Admins:'..msg.chat_id_,result.sender_user_id_)
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙ليست لدي صلاحية اضافة مشرفين جدد يرجى التحقق من الصلاحيات', 1, 'md')
end
end
getMessage(msg.chat_id_, msg.reply_to_message_id_,promote_by_reply)
end
...
ReplyStatus(msg,result.sender_user_id_,"Reply","༒︎︙تم اضافة ↫ "..Abd.." كلقب له")  
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم تفعيل رفع ↫ الادمن • المميز', 1, 'md')
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم تعطيل رفع ↫ الادمن • المميز', 1, 'md')
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
--          Kick          --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع طرد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع طرد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع طرد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع حظر ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.sender_user_id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"༒︎︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع حظر ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=result.id_,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"༒︎︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
if RankChecking(user, msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع حظر ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
tdcli_function({ID="ChangeChatMemberStatus",chat_id_=msg.chat_id_,user_id_=user,status_={ID="ChatMemberStatusKicked"},},function(arg,dp) 
if (dp and dp.code_ and dp.code_ == 400 and dp.message_ == "CHAT_ADMIN_REQUIRED") then 
send(msg.chat_id_,msg.id_,"༒︎︙ليس لدي صلاحية حظر المستخدمين يرجى تفعيلها !") 
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع كتم ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع كتم ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
if RankChecking(user, msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع كتم ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
if RankChecking(result.sender_user_id_, result.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع تقيد ↫ '..IdRank(result.sender_user_id_, msg.chat_id_), 1, 'md')
else
...
if result.id_ then
if RankChecking(result.id_, msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع تقيد ↫ '..IdRank(result.id_, msg.chat_id_), 1, 'md')
else
...
if RankChecking(user, msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا تستطيع تقيد ↫ '..IdRank(user, msg.chat_id_), 1, 'md')
else
...
if tonumber(result.sender_user_id_) == tonumber(ALSHBAH) then  
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙*لاتستطيع حظر البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙*لاتستطيع حظر المطور الاساسي*", 1, 'md')
return false 
end
...
if tonumber(result.sender_user_id_) == tonumber(ALSHBAH) then  
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙*لاتستطيع كتم البوت عام*", 1, 'md')
return false 
end
if SudoId(result.sender_user_id_) == true then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙*لاتستطيع كتم المطور الاساسي*", 1, 'md')
return false 
end
if DevAbd:sismember(ALSHBAH..'Abd:SecondSudo:',result.sender_user_id_) and not Sudo(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙*لاتستطيع كتم المطور الاساسي²*", 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل عدد الرسائل الان \n༒︎︙ارسل الغاء لالغاء الامر ", 1, "md")
Dev_Abd(msg.chat_id_, msg.id_, 1,numd, 1, 'md') 
else 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙هذا الامر للمنشئين فقط', 1, 'md') 
end 
end 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم اضافة "..Num..' رساله', 1, 'md') 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل عدد النقاط الان \n༒︎︙ارسل الغاء لالغاء الامر ", 1, "md")
Dev_Abd(msg.chat_id_, msg.id_, 1,numd, 1, 'md') 
else 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙هذا الامر للمنشئين فقط', 1, 'md') 
end 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم اضافة "..Num..' نقطه', 1, 'md') 
end
tdcli_function ({ID = "GetMessage",chat_id_=msg.chat_id_,message_id_=tonumber(msg.reply_to_message_id_)},Reply, nil)
return false
end
...
Dev_Abd(msg.chat_id_,msg.id_, 1, "༒︎︙التثبيت والغاء واعادة التثبيت تم قفله من قبل المنشئين الاساسيين", 1, 'md')
return false  
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙البوت ليس ادمن هنا !', 1, 'md')
return false  
end
if data.message_ == "CHAT_ADMIN_REQUIRED" then
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙ليست لدي صلاحية التثبيت يرجى التحقق من الصلاحيات', 1, 'md')
return false  
end
end,nil)
end 
...
if dp.first_name_ == false then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙حساب المنشئ محذوف", 1, "md")
return false  
end
local UserName = (dp.username_ or "DDDFDI")
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙مالك المجموعه ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md")  
end,nil)   
end
end
end,nil)   
...
local UserName = (dp.username_ or "DDDFDI")
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم رفع مالك المجموعه ↫ ["..dp.first_name_.."](T.me/"..UserName..")", 1, "md") 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم منع الملصق بنجاح لن يتم ارساله مجددا', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevAbd:sadd(ALSHBAH.."Abd:FilterPhoto"..msg.chat_id_,photo)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم منع الصوره بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
if result.content_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevAbd:sadd(ALSHBAH.."Abd:FilterAnimation"..msg.chat_id_,idanimation)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم منع المتحركه بنجاح لن يتم ارسالها مجددا', 1, 'md')
return false
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء منع الملصق يمكنهم ارساله الان', 1, 'md')
return false
end
if result.content_.ID == "MessagePhoto" then
local photo = result.content_.photo_.id_
DevAbd:srem(ALSHBAH.."Abd:FilterPhoto"..msg.chat_id_,photo)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء منع الصوره يمكنهم ارسالها الان', 1, 'md')
return false
end
if result.content_.animation_.animation_ then
local idanimation = result.content_.animation_.animation_.persistent_id_
DevAbd:srem(ALSHBAH.."Abd:FilterAnimation"..msg.chat_id_,idanimation)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء منع المتحركه يمكنهم ارسالها الان', 1, 'md')
return false
end
end
...
sudobot = '\n༒︎︙عدد الكروبات ↫ '..(DevAbd:get(ALSHBAH..'Abd:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙الحساب محذوف', 1, 'md')
return false  end
if data.username_ == false then
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙معرفه ↫ [@'..data.username_..']\n༒︎︙ايديه ↫ ❨ `'..result.sender_user_id_..'` ❩\n༒︎︙رتبته ↫ '..IdRank(result.sender_user_id_, msg.chat_id_)..''..sudobot..'\n༒︎︙رسائله ↫ ❨ '..user_msgs..' ❩\n༒︎︙تفاعله ↫ '..formsgs(user_msgs)..''..CustomTitle..'\n༒︎︙نقاطه ↫ ❨ '..user_nkt..' ❩'..Tked, 1, 'md')
end
end,nil)
end 
...
sudobot = '\n༒︎︙عدد الكروبات ↫ '..(DevAbd:get(ALSHBAH..'Abd:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙لم يتم التعرف على الحساب', 1, 'md')
return false  
end
...
sudobot = '\n༒︎︙عدد الكروبات ↫ '..(DevAbd:get(ALSHBAH..'Abd:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الحظر العام ↫ '..banall..'\n༒︎︙الكتم العام ↫ '..muteall..'\n༒︎︙الحظر ↫ '..banned..'\n༒︎︙الكتم ↫ '..muted..'\n༒︎︙التقيد ↫ '..tkeed..'', 1, 'md')  
end
...
function unbanreply(extra, result, success) 
if tonumber(result.sender_user_id_) == tonumber(ALSHBAH) then  
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙انا البوت وليس لدي قيود', 1, 'md')  
return false  
end 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لم استطع استخراج المعلومات', 1, 'md') 
return false  
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙هذا معرف قناة وليس معرف حساب', 1, 'md') 
return false  
end
if tonumber(result.id_) == tonumber(ALSHBAH) then  
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙انا البوت وليس لدي قيود', 1, 'md')  
...
if text == 'الغاء' then   
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء حفظ كليشة الايدي', 1, 'md')
DevAbd:del("ALSHBAH:New:id:"..ALSHBAH..msg.sender_user_id_)
return false
end
DevAbd:del("ALSHBAH:New:id:"..ALSHBAH..msg.sender_user_id_)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ كليشة الايدي العامه', 1, 'md')
...
DevAbd:del("ALSHBAH:New:id:"..ALSHBAH..msg.chat_id_..msg.sender_user_id_)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ الكليشه الجديده', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عذرا الايدي معطل ', 1, 'md')
end
else
if DevAbd:get(ALSHBAH.."Abd:AllIds:Text") then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙معرفك ↫ ❨ "..username.." ❩\n༒︎︙ايديك ↫ ❨ "..msg.sender_user_id_.." ❩\n༒︎︙رتبتك ↫ "..IdRank(msg.sender_user_id_, msg.chat_id_).."\n༒︎︙رسائلك ↫ ❨ "..user_msgs.." ❩\n༒︎︙سحكاتك ↫ ❨ "..edit_msg.." ❩\n༒︎︙رسائلك ↫ ❨ "..user_msgs.." ❩\n༒︎︙تفاعلك ↫ "..formsgs(msguser).."\n༒︎︙نقاطك ↫ ❨ "..user_nkt.." ❩", 1, 'md')
end
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عذرا الايدي معطل', 1, 'md')
end end end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙التعديل بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تعديل الميديا بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفارسيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفشار بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الطائفيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الكفر بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفارسيه بالطرد بالفعل مقفله ', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙التثبيت بالفعل مقفل في المجموعه', 1, 'md')
end end end
end
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙قم بتحديد عدد اكبر من 2 للتكرار', 1, 'md')
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم وضع عدد التكرار ↫ '..TextSpam, 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم وضع زمن التكرار ↫ '..TextSpam, 1, 'md')
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
if Manager(msg) then
if text and text == 'تفعيل الايدي بالصوره' and ChCheck(msg) then
if not DevAbd:get(ALSHBAH..'Abd:Lock:Id:Photo'..msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الايدي بالصوره بالتاكيد مفعل', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الايدي بالصوره بالتاكيد معطل', 1, 'md')
else
...
if not DevAbd:get(ALSHBAH..'Abd:Lock:Id'..msg.chat_id_) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الايدي بالتاكيد مفعل ', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الايدي بالتاكيد معطل ', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙ارسل رابط المجموعه او رابط قناة المجموعه', 1, 'md')
...
LinkGroup = LinkGp.result
DevAbd:set(ALSHBAH.."Abd:Groups:Links"..msg.chat_id_,LinkGroup) 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم انشاء رابط جديد ارسل ↫ الرابط', 1, 'md')
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙ليست لدي صلاحية دعوة المستخدمين عبر الرابط يرجى التحقق من الصلاحيات', 1, 'md')
end
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙ارسل رابط المجموعه او رابط قناة المجموعه', 1, 'md')
DevAbd:setex(ALSHBAH.."Abd:Set:Groups:Links"..msg.chat_id_..""..msg.sender_user_id_,300,true) 
...
if text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء حفظ كليشة الترحيب', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ كليشة الترحيب', 1, 'md')
return false   
end
...
if text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر المنع', 1, 'md')
DevAbd:del(ALSHBAH.."Abd:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم منع الكلمه ↫ "..text, 1, 'html')
DevAbd:del(ALSHBAH.."Abd:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
...
if text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر الغاء المنع', 1, 'md')
DevAbd:del(ALSHBAH.."Abd:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
return false  
end   
if not DevAbd:hget(ALSHBAH..'Abd:Filters:'..msg.chat_id_, text) then  
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙الكلمه ↫ "..text.." غير ممنوعه", 1, 'html')
DevAbd:del(ALSHBAH.."Abd:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
else
DevAbd:hdel(ALSHBAH..'Abd:Filters:'..msg.chat_id_, text)
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙الكلمه ↫ "..text.." تم الغاء منعها", 1, 'html')
DevAbd:del(ALSHBAH.."Abd:SetFilters"..msg.sender_user_id_..msg.chat_id_)  
end
return false
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عدد المجموعات ↫ ❨ '..gps..' ❩', 1, 'md')
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
if Number > 2000 then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لاتستطيع تنظيف اكثر من 2000 رساله', 1, 'md')
return false  
end  
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم تنظيف *'..Number..'* من الرسائل', 1, 'md')
...
if #pv == i then 
if sendok == 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙*لا يوجد مشتركين وهميين*', 1, 'md')
else
local ok = #pv - sendok
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عدد المشتركين الان ↫ { '..#pv..' }\n༒︎︙تم حذف ↫ { '..sendok..' } من المشتركين\n༒︎︙العدد الحقيقي الان  ↫ ( '..ok..' ) \n', 1, 'md')
end
end
end,nil)
end,nil)
...
if #group == i then 
if (w + q) == 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙*لاتوجد مجموعات وهميه*', 1, 'md')   
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1,'༒︎︙عدد الكروبات الان ↫ { '..#group..' }'..ALSHBAHgp1..''..ALSHBAHgp2..'\n༒︎︙العدد الحقيقي الان  ↫ ( '..ALSHBAHgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙قم بتحديد عدد اكبر من 50 واصغر من 1000 للحذف التلقائي', 1, 'md')
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم وضع ↫ *'..Num..'* من الميديا للحذف التلقائي', 1, 'md')
...
if M ~= 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙عدد الميديا ↫ "..M.."\n༒︎︙الحذف التلقائي ↫ "..(DevAbd:get(ALSHBAH..'Abd:CleanNum'..msg.chat_id_) or 200), 1, 'md') 
else
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لاتوجد ميديا هنا", 1, 'md') 
end end
...
if Del ~= 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف "..Del.." من الميديا", 1, 'md') 
DevAbd:del(ALSHBAH.."Abd:cleaner"..msg.chat_id_)
else
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لاتوجد ميديا هنا", 1, 'md') 
end end 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم تنظيف 100 من الرسائل المعدله', 1, 'md')
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
if ChatType == 'sp' or ChatType == 'gp'  then
if Admin(msg) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙التعديل بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تعديل الميديا بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفارسيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفشار بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الطائفيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الكفر بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفارسيه بالطرد بالفعل مفتوحه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙التثبيت بالفعل مفتوح في المجموعه', 1, 'md')
end end end
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الدردشه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الاونلاين بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الصور بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الكلايش بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الدخول بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفيديو بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المتحركه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الاغاني بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الصوت بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الروابط بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المواقع بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المعرفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الملفات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الهاشتاك بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '️༒︎︙الجهات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الشبكات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙العربيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الانكليزيه بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الملصقات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الماركداون بالفعل مقفل في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الاشعارات بالفعل مقفله في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙التوجيه بالفعل مقفل في المجموعه', 1, 'md')
end
end
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الدردشه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الصور بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الكلايش بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الدخول بالفعل مفتوح في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الفيديو بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الملفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الاونلاين بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الماركداون بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المتحركه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الاغاني بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الصوت بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الروابط بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المواقع بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المعرفات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الهاشتاك بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الجهات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الشبكات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙العربيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الانكليزيه بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الاشعارات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙الملصقات بالفعل مفتوحه في المجموعه', 1, 'md')
end
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙التوجيه بالفعل مفتوح في المجموعه', 1, 'md')
end
end
end
end
...
if not Constructor(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙للمنشئين فقط', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙اختر عدد اكبر من 40 حرف ', 1, 'md')
else
DevAbd:set(ALSHBAH..'Abd:Spam:Text'..msg.chat_id_,SetSpam)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم وضع عدد السبام ↫'..SetSpam, 1, 'md')
end
end
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
if #admins == 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙*لاتوجد بوتات هنا*", 1, 'md')
return false end
if #admins == i then 
local a = '┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n༒︎︙*عدد البوتات هنا* ↫ '..n..'\n'
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙للمنشئ الاساسي فقط', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف ↫ ❨ قائمة المنع • المحظورين • المكتومين • الادمنيه • المميزين • المطايه ❩ بنجاح \n ✓", 1, 'md')
end end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
if text and text:match("^حذف جميع الرتب$") and ChCheck(msg) or text and text:match("^مسح جميع الرتب$") and ChCheck(msg) or text and text:match("^تنزيل جميع الرتب$") and ChCheck(msg) then
if not AbdConstructor(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙للمالكين فقط', 1, 'md')
else
...
DevAbd:del(ALSHBAH..'Abd:VipMem:'..msg.chat_id_)
DevAbd:del(ALSHBAH..'User:Donky:'..msg.chat_id_)
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف جميع الرتب التاليه ↫ ❨ "..basicconstructort..''..constructort..''..Managerst..''..adminst..''..vipmemt..''..donkyt.." ❩ بنجاح \n ✓", 1, 'md')
else
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لاتوجد رتب هنا", 1, 'md')
end 
end 
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
if text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء حفظ قوانين المجموعه', 1, 'md')
DevAbd:del(ALSHBAH..'Abd:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
return false  
end 
DevAbd:del(ALSHBAH..'Abd:setrules'..msg.chat_id_..':'..msg.sender_user_id_)
DevAbd:set(ALSHBAH..'Abd:rules'..msg.chat_id_,text)
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حفظ قوانين المجموعه', 1, 'md')
return false   
end
if text and text:match("^ضع قوانين$") and ChCheck(msg) or text and text:match("^وضع قوانين$") and ChCheck(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙ارسل لي القوانين الان', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر الزخرفه', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙ارسل لي الكلمه لزخرفتها \nيمكنك الزخرفة باللغه { en } ~ { ar } ', 1, 'md')
end
end
if not DevAbd:get(ALSHBAH..'Abd:Zrf:Abd'..msg.chat_id_) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙قم بارسل اسمين لحساب نسبة الحب بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
if text and text ~= "نسبه الحب" and text ~= "نسبة الحب" and DevAbd:get(ALSHBAH..'LoveNsba:Abd'..msg.chat_id_..msg.sender_user_id_) then
if text and text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر نسبة الحب ', 1, 'md')
DevAbd:del(ALSHBAH..'LoveNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abd = math.random(0,100);
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙نسبة الحب بين '..text..' هي : '..Abd..'%', 1, 'md')
DevAbd:del(ALSHBAH..'LoveNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbd:get(ALSHBAH..'Abd:Nsba:Abd'..msg.chat_id_) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙قم بارسل اسمين لحساب نسبة الكره بينهما كمثال ↫ جاك وروز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر نسبة الكره ', 1, 'md')
DevAbd:del(ALSHBAH..'HataNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abd = math.random(0,100);
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙نسبة الكره بين '..text..' هي : '..Abd..'%', 1, 'md')
DevAbd:del(ALSHBAH..'HataNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbd:get(ALSHBAH..'Abd:Nsba:Abd'..msg.chat_id_) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙قم بارسل اسم الشخص لقياس نسبة رجولته كمثال ↫ جاك', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر نسبة الرجوله ', 1, 'md')
DevAbd:del(ALSHBAH..'RjolaNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abd = math.random(0,100);
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙نسبة رجولة '..text..' هي : '..Abd..'%', 1, 'md')
DevAbd:del(ALSHBAH..'RjolaNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbd:get(ALSHBAH..'Abd:Nsba:Abd'..msg.chat_id_) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙قم بارسل اسم الشخص لقياس نسبة انوثته كمثال ↫ روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر نسبة الانوثه ', 1, 'md')
DevAbd:del(ALSHBAH..'AnothaNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abd = math.random(0,100);
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙نسبة انوثة '..text..' هي : '..Abd..'%', 1, 'md')
DevAbd:del(ALSHBAH..'AnothaNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
if not DevAbd:get(ALSHBAH..'Abd:Nsba:Abd'..msg.chat_id_) then
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙قم بارسل اسم الشخص لقياس نسبة غبائه كمثال ↫ جاك او روز', 1, 'md')
end
end
...
if text and text == 'الغاء' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم الغاء امر نسبة الغباء ', 1, 'md')
DevAbd:del(ALSHBAH..'StupidNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end 
Abd = math.random(0,100);
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙نسبة غباء '..text..' هي : '..Abd..'%', 1, 'md')
DevAbd:del(ALSHBAH..'StupidNsba:Abd'..msg.chat_id_..msg.sender_user_id_) 
return false 
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_,msg.id_, 1, '༒︎︙ارسل صورة المجموعه الان', 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 0,'༒︎︙*لا يوجد محظورين*', 1, 'md')
...
Dev_Abd(Text[2], 0, 1, "༒︎︙بامر المطور تم مغادرة هذه المجموعه ", 1, "md")  
ChatLeave(dp.id_, ALSHBAH)
DevAbd:srem(ALSHBAH.."Abd:Groups", dp.id_)
else
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لم تتم اضافتي بها لاقوم بمغادرتها", 1, "md")
end 
end,nil)
end 
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم وضع عدد الاعضاء ↫ *'..Num..'* عضو', 1, 'md')
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙المجموعه بالتاكيد معطله', 1, 'md')
else
...
local List = DevAbd:smembers(ALSHBAH.."Abd:Groups")
if #List == 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لا يوجد مجموعات مفعله', 1, 'md')
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙جاري ارسال نسخه تحتوي على '..#List..' مجموعه', 1, 'md')
local text = "༒︎︙༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎\n༒︎︙File Bot Groups\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n"
for k,v in pairs(List) do
...
if text == 'الغاء' then   
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم الغاء امر الاذاعه بنجاح", 1, 'md')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم اذاعة "..AbdText.." بنجاح \n༒︎︙‏الى ↫ ❨ "..#List.." ❩ مشترك \n ✓", 1, 'md')
DevAbd:del(ALSHBAH.."Abd:Send:Pv" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم اذاعة "..AbdText.." بالتثبيت \n༒︎︙‏في ↫ ❨ "..#List.." ❩ مجموعه \n ✓", 1, 'md')
DevAbd:del(ALSHBAH.."Abd:Send:Gp:Pin" .. msg.chat_id_ .. ":" .. msg.sender_user_id_) 
return false
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙حسنا ارسل الكلمه لحذفها " ,  1, "md")
return false
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙حسنا ارسل الكلمه الان " ,  1, "md")
return false
end
if text and text:match("^(.*)$") then
local SetGpRed = DevAbd:get(ALSHBAH..'Abd:Add:GpRed'..msg.sender_user_id_..''..msg.chat_id_..'')
if SetGpRed == 'SetGpRed' then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل لي الرد سواء كان ↫ ⤈\n❨ ملف • ملصق • متحركه • صوره\n • فيديو • بصمه • صوت • رساله ❩\n༒︎︙يمكنك اضافة الى النص ↫ ⤈\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n `#username` ↬ معرف المستخدم\n `#msgs` ↬ عدد الرسائل\n `#name` ↬ اسم المستخدم\n `#id` ↬ ايدي المستخدم\n `#stast` ↬ رتبة المستخدم\n `#edit` ↬ عدد السحكات\n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n༒︎︙للخروج ارسل ↫ ( الغاء )\n ✓" ,  1, "md")
...
local redod = DevAbd:smembers(ALSHBAH..'Abd:Manager:GpRed'..msg.chat_id_..'')
if #redod == 0 then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙لا توجد ردود مضافه" ,  1, "md")
else
for k,v in pairs(redod) do
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل لي اسم البوت الان" ,  1, "md") 
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم استعادة الكلايش الاصليه" ,  1, "md") 
end
if text == "تعيين الاوامر" and SecondSudo(msg) or text == "تعيين امر الاوامر" and SecondSudo(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة (الاوامر) الان " ,  1, "md")
...
if not Admin(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙هذا الامر يخص الرتب الاعلى فقط\n༒︎︙ارسل ↫ (م6) لعرض اوامر الاعضاء', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة (م1) الان " ,  1, "md")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة (م2) الان " ,  1, "md")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة (م3) الان " ,  1, "md")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة (م4) الان " ,  1, "md")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة (م5) الان " ,  1, "md")
...
if not SudoBot(msg) then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙هذا الامر للمطورين فقط', 1, 'md')
else
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة (م6) الان " ,  1, "md")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙جاري تحديث سورس شبح', 1, 'md') 
os.execute('rm -rf ALSHBAH.lua') 
os.execute('wget https://raw.githubusercontent.com/ALSHBAHTeAM/ALSHBAH/main/ALSHBAH.lua') 
dofile('ALSHBAH.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n          ( تم تحديث السورس )          \n\27[0;34;49m\n") 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم التحديث الى الاصدار الجديد', 1, 'md') 
end
if text == 'تحديث' or text == 'تحديث البوت' or text == '↫ تحديث ༒︎' then  
dofile('ALSHBAH.lua') 
io.popen("rm -rf ../.telegram-cli/*")
print("\27[31;47m\n        ( تم تحديث ملفات البوت )        \n\27[0;34;49m\n") 
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم تحديث ملفات البوت", 1, "md")
end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم حذف معلومات الترحيب', 1, 'md')   
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم تفعيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم تعطيل الترحيب عند اضافة البوت في المجموعه', 1, 'md')   
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙ارسل لي نص الترحيب', 1, 'md') 
DevAbd:del(ALSHBAH..'Abd:Text:BotWelcome')
DevAbd:del(ALSHBAH..'Abd:Photo:BotWelcome')
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حفظ النص ارسل لي صورة الترحيب\n༒︎︙ارسل ↫ الغاء لحفظ النص فقط", 1, 'md')   
...
if text and text:match("^الغاء$") then 
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حفظ النص والغاء حفظ صورة الترحيب", 1, "md") 
DevAbd:del(ALSHBAH.."Abd:Set:BotWelcome"..msg.sender_user_id_)    
return false
end 
if msg.content_.photo_ and msg.content_.photo_.sizes_[1] then   
DevAbd:set(ALSHBAH.."Abd:Photo:BotWelcome",msg.content_.photo_.sizes_[1].photo_.persistent_id_)
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حفظ النص وصورة الترحيب", 1, 'md')   
DevAbd:del(ALSHBAH.."Abd:Set:BotWelcome"..msg.sender_user_id_)   
end
return false
end
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙ارسل كليشة المطور الان ", 1, "md")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, "༒︎︙تم حذف كليشة المطور", 1, "md")
...
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙تم تغيير كليشة الاشتراك الاجباري', 1, 'md')
end
...
if chtext then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙كليشة الاشتراك ↫ ⤈ \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n['..chtext..']', 1, 'md')
else
local DevAbd6 = DevAbd:get(ALSHBAH.."DevAbd3")
if DevAbd6 then
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙عليك الاشتراك في قناة البوت \n༒︎︙قناة البوت ↫ '..DevAbd6, 1, "html")
else
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙لم يتم تعيين قناة الاشتراك الاجباري \n༒︎︙ارسل ↫ تعيين قناة الاشتراك للتعيين ', 1, 'md')
end end end end
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
if text == 'القناة' or text == 'قناة السورس' or text == 'قناه السورس' or text == 'قنات السورس' then 
Dev_Abd(msg.chat_id_, msg.id_, 1, '༒︎︙Channel ↬ @DDDFDI', 1, 'html')    
end 
--     ༒︎𝑨𝑳-𝑺𝑯𝑨𝑩𝑨𝑯༒︎     --
if Sudo(msg) then 
...
local Abdname = '༒︎︙العضو ↫ ['..dp.first_name_..'](tg://user?id='..dp.id_..')'
local Abdid = '༒︎︙ايديه ↫ `'..dp.id_..'`'
local Abdtext = '༒︎︙قام بالتعديل على '..Media
